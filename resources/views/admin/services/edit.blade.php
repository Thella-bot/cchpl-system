...
@section('content')
<div class="mb-4">
    <h1 class="h3 fw-bold mb-1">Edit {{ ucfirst($label) }}</h1>
    <p class="text-muted mb-0">Update {{ strtolower($label) }} details.</p>
</div>

<div class="admin-shell-card">
    <form method="POST" action="{{ route('admin.services.update', [$type, $item->id]) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row g-3">
            <div class="col-md-6">
                <label for="title" class="form-label fw-semibold small text-muted">Title</label>
                <input type="text" id="title" name="title" value="{{ old('title', $item->title) }}" class="form-control @error('title') is-invalid @enderror" required>
            ...
            <div class="col-md-6">
                ...
                <select id="membership_category_id" name="membership_category_id" class="form-select @error('membership_category_id') is-invalid @enderror">
                    ...
                    @foreach($categories as $category)
                        <option value="{{ $category->id }}" {{ old('membership_category_id', $item->membership_category_id) == $category->id ? 'selected' : '' }}>
                            {{ $category->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="col-12">
                ...
                <textarea id="description" name="description" rows="4" class="form-control @error('description') is-invalid @enderror">{{ old('description', $item->description) }}</textarea>
            ...
            @if($type === 'minutes')
                <div class="col-md-6">
                    ...
                    <input type="date" id="meeting_date" name="meeting_date" value="{{ old('meeting_date', $item->meeting_date) }}" class="form-control @error('meeting_date') is-invalid @enderror" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="location" name="location" value="{{ old('location', $item->location) }}" class="form-control @error('location') is-invalid @enderror">
                ...
                <div class="col-12">
                    ...
                    @if($item->file_path)
                        <div class="mt-2">
                            <a href="{{ asset('storage/' . $item->file_path) }}" target="_blank" class="small">
            ...
            @if($type === 'events')
                <div class="col-md-6">
                    ...
                    <input type="datetime-local" id="event_date" name="event_date" value="{{ old('event_date', $item->event_date) }}" class="form-control @error('event_date') is-invalid @enderror" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="venue" name="venue" value="{{ old('venue', $item->venue) }}" class="form-control @error('venue') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    ...
                    @if($item->image_path)
                        <div class="mt-2">
                            <img src="{{ asset('storage/' . $item->image_path) }}" alt="Event image" style="height: 60px;">
                        </div>
                    @endif
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="capacity" name="capacity" value="{{ old('capacity', $item->capacity) }}" class="form-control @error('capacity') is-invalid @enderror">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="spots_taken" name="spots_taken" value="{{ old('spots_taken', $item->spots_taken) }}" class="form-control @error('spots_taken') is-invalid @enderror">
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" id="registration_deadline" name="registration_deadline" value="{{ old('registration_deadline', $item->registration_deadline) }}" class="form-control @error('registration_deadline') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.01" id="price" name="price" value="{{ old('price', $item->price) }}" class="form-control @error('price') is-invalid @enderror">
                    @error('price')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6">
                    <label for="currency" class="form-label fw-semibold small text-muted">Currency</label>
                    <input type="text" id="currency" name="currency" value="{{ old('currency', $item->currency) }}" class="form-control @error('currency') is-invalid @enderror">
            ...
            @if(in_array($type, ['jobs', 'scholarships', 'internships']))
                <div class="col-md-6">
                    ...
                    <input type="text" id="company_name" name="company_name" value="{{ old('company_name', $item->company_name) }}" class="form-control @error('company_name') is-invalid @enderror" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" id="application_deadline" name="application_deadline" value="{{ old('application_deadline', $item->application_deadline) }}" class="form-control @error('application_deadline') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" id="application_url" name="application_url" value="{{ old('application_url', $item->application_url) }}" class="form-control @error('application_url') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" id="contact_email" name="contact_email" value="{{ old('contact_email', $item->contact_email) }}" class="form-control @error('contact_email') is-invalid @enderror">
            ...
            @if($type === 'jobs')
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="employment_type" name="employment_type" value="{{ old('employment_type', $item->employment_type) }}" class="form-control @error('employment_type') is-invalid @enderror" placeholder="e.g. Full-time, Part-time, Contract">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="salary_range" name="salary_range" value="{{ old('salary_range', $item->salary_range) }}" class="form-control @error('salary_range') is-invalid @enderror">
            ...
            @if($type === 'scholarships')
                <div class="col-md-6">
                    ...
                    <input type="text" id="provider" name="provider" value="{{ old('provider', $item->provider) }}" class="form-control @error('provider') is-invalid @enderror">
                ...
                <div class="col-12">
                    ...
                    <textarea id="eligibility" name="eligibility" rows="3" class="form-control @error('eligibility') is-invalid @enderror">{{ old('eligibility', $item->eligibility) }}</textarea>
                ...
                <div class="col-12">
                    ...
                    <textarea id="benefit" name="benefit" rows="3" class="form-control @error('benefit') is-invalid @enderror">{{ old('benefit', $item->benefit) }}</textarea>
            ...
            @if($type === 'internships')
                <div class="col-md-6">
                    ...
                    <input type="text" id="duration" name="duration" value="{{ old('duration', $item->duration) }}" class="form-control @error('duration') is-invalid @enderror" placeholder="e.g. 3 months, 6 months">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="stipend" name="stipend" value="{{ old('stipend', $item->stipend) }}" class="form-control @error('stipend') is-invalid @enderror" placeholder="e.g. M2,000/month">
            ...
            <div class="col-12">
                <div class="form-check form-switch">
                    <input type="checkbox" id="is_published" name="is_published" value="1" {{ old('is_published', $item->is_published) ? 'checked' : '' }} class="form-check-input">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" id="expires_at" name="expires_at" value="{{ old('expires_at', $item->expires_at?->format('Y-m-d')) }}" class="form-control @error('expires_at') is-invalid @enderror">
